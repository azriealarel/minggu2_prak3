...
Route::get('/', function () {
    echo('SELAMAT DATANG <br> Menampilkan Halaman Pertama Website <br> Muhammad Azrieal Rhamdan <br> MI 2F <br> 2031710169');
});
...
Route::get('/AboutUS', function () {
    echo('SAMPAI JUMPA KEMBALI <br>Muhammad Azrieal Rhamdan <br> MI 2F <br> 2031710169');
});
